...
export function Projects() {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Front End": "from-red-500 to-orange-500",
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2 relative">
                <div className="relative bg-black/40 border border-purple-500/20 rounded-2xl overflow-hidden">
                  <Image
                    src={project.image}
                    alt={project.title}
                    width={800}
              ...
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                  <Button
                    asChild
                    className="bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold px-8 py-3 rounded-xl shadow-lg"
                  >
